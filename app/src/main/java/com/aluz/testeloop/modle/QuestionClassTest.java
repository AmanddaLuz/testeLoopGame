...
public class QuestionClassTest {
    ...
    public QuestionClassTest(String question, String alternativeA, String alternativeB, String alternativeC, String alternativeD, String alternativeE, String correctAlter) {
        this.que = question;
